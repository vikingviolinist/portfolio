	...
	>
		<defs id="defs1208">
			<pattern
				...
				id="pattern2736"
				patternTransform="translate(0.02474227,2.5202279)"
			/>
			<pattern
				xlink:href="#pattern"
				id="pattern2445"
				patternTransform="matrix(0.02055921,0,0,0.02055921,1.1464844e-6,3.6052155e-6)"
			/>
			<pattern id="pattern" x="0" y="0" width="304" height="304" patternUnits="userSpaceOnUse">
				<path
					fill="#454e56"
					fill-rule="evenodd"
			...
			<pattern
				...
				width="25"
				height="25"
				patternTransform="translate(71.486725,3.1389463)"
				id="pattern2447"
			>
				<rect
					width="25"
					...
					x="0"
					y="0"
					style="fill:url(#pattern2445);stroke-width:0.0205593"
				/>
			</pattern>
		</defs>
		<sodipodi:namedview
		...
		/>
		<rect
			style="fill:url(#pattern2736);fill-opacity:1;stroke:none;stroke-width:0.1"
			id="rect2572"
			width="100%"
			height="100%"
			x="0"
		...
		/>
		<rect
			style="fill:#454e56;fill-opacity:1;stroke:none;stroke-width:0.09826772;stroke-miterlimit:4;stroke-dasharray:none"
			id="rect2734"
			width="100%"
			height="100%"
			x="0"
